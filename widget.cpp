...
{
    ui->webView->load(QUrl(qApp->applicationDirPath()+"/html/pie.html"));
}

void Widget::on_btnRadar_clicked()
{
    ui->webView->load(QUrl(qApp->applicationDirPath()+"/html/radar.html"));
}
...
{
    ui->webView->load(QUrl(qApp->applicationDirPath()+"/html/gauge.html"));
}

void Widget::on_btnFunnel_clicked()
{
    ui->webView->load(QUrl(qApp->applicationDirPath()+"/html/funnel.html"));
}

void Widget::on_btnData_clicked()
{
    ui->webView->load(QUrl(qApp->applicationDirPath()+"/html/data.html"));
}
